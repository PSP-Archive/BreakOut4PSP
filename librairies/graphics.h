...
extern void blitImageToScreen(int dw, int dh, Image* source, int dx, int dy);
extern void blitImagePartToScreen(int sx, int sy, int width, int height, Image* source, int dx, int dy);
